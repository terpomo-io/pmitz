...
class CalendarPeriodRateLimitTest {
    ...
    void getWindowStartShouldReturnFirstNanosecondInHourWhenPeriodicityIsHour() {
        CalendarPeriodRateLimit rateLimit = new CalendarPeriodRateLimit(10, CalendarPeriodRateLimit.Periodicity.HOUR);
    ...
    void getWindowStartShouldReturnFirstNanosecondInDayWhenPeriodicityIsDay() {
        CalendarPeriodRateLimit rateLimit = new CalendarPeriodRateLimit(10, CalendarPeriodRateLimit.Periodicity.DAY);
    ...
    void getWindowStartShouldReturnFirstDayInMonthWhenPeriodicityIsMonth() {
        CalendarPeriodRateLimit rateLimit = new CalendarPeriodRateLimit(10, CalendarPeriodRateLimit.Periodicity.MONTH);
    ...
    void getWindowStartShouldReturnJanuary1stWhenPeriodicityIsYear() {
        CalendarPeriodRateLimit rateLimit = new CalendarPeriodRateLimit(10, CalendarPeriodRateLimit.Periodicity.YEAR);
